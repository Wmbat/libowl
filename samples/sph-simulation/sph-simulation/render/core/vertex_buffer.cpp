...
auto create_buffer(const vertex_buffer_create_info& info) -> cacao::buffer
{
...
auto vertex_buffer::buffer() const noexcept -> const cacao::buffer&
{
   return m_buffer;
}
auto vertex_buffer::buffer() noexcept -> cacao::buffer&
{
   return m_buffer;
}

auto vertex_buffer::vertex_count() const noexcept -> mannele::u64
{
