...
namespace vkn
{
   ...
   builder::builder(const cacao::device& device, util::logger_wrapper logger) noexcept :
      ...
      return try_wrap([&] {
                return m_device.allocateDescriptorSets(
                   vk::DescriptorSetAllocateInfo{}
                      .setDescriptorPool(handle.get())
                      .setDescriptorSetCount(m_info.max_set_count.value())
