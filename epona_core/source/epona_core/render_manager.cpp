...
namespace core
{
      ...
      p_window{p_wnd}, p_logger{p_logger}, loader{p_logger}
   {
      ...
      device = gfx::vkn::device_builder{loader,
         gfx::vkn::physical_device_selector{instance, p_logger}
            .set_surface(p_wnd->get_surface(instance.h_instance)
            ...
            .join(), p_logger}
         .build()
         .left_map(std::bind(handle_device_error, _1, p_logger))
         .join();
      // clang-format on
   }
