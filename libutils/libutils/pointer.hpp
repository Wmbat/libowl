...
{
   template <typename Any>
   struct hash<util::non_null<Any>>
   {
      auto operator()(const util::non_null<Any>& value) const -> std::size_t
      {
