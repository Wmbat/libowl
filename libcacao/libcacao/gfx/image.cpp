#include <libcacao/gfx/image.hpp>
...
namespace cacao
{
   ...
   auto find_depth_format(const cacao::device& device) -> maybe<vk::Format>
   {
   ...
   auto find_colour_format(const cacao::device& device) -> maybe<vk::Format>
   {
